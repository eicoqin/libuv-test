...
namespace RPC
{
	struct PkgGenMd5
	{
		static constexpr char const* value = "b44062b073ce1592e38c138fc475de27";
	};
	...
	namespace Generic
	{
			...
			: xx::Object(bb)
		{
			...
			bb->readLengthLimit = 0;
			if (rtv = bb->Read(serviceId)) throw rtv;
		}
		inline void ServiceInfo::ToBBuffer(xx::BBuffer &bb) const
		{
			bb.Write(this->type);
			bb.Write(this->serviceId);
		}
		inline int ServiceInfo::FromBBuffer(xx::BBuffer &bb)
		{
			...
			bb.readLengthLimit = 0;
			if (rtv = bb.Read(this->serviceId)) return rtv;
			return rtv;
		}
		...
		inline void ServiceInfo::ToStringCore(xx::String &str) const
		{
			...
			if (this->serviceId) str.Append(", \"serviceId\" : \"", this->serviceId, "\"");
			else str.Append(", \"serviceId\" : nil");
		}
